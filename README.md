# CS571-SU26 HW3: Badger Mart (React!)
...
This assignment has you fetching data from `https://cs571api.cs.wisc.edu/rest/su26/hw3/featured-item`, which changes on a daily basis. To see how your code reacts to any given day's feature, you can specify an optional query parameter of 'day', e.g. `https://cs571api.cs.wisc.edu/rest/su26/hw3/featured-item?day=Friday`. This is simply for your testing purposes.
...
In `BadgerMart.jsx`, fetch today's featured item from `https://cs571api.cs.wisc.edu/rest/su26/hw3/featured-item` and save it to the `feature` state variable via its mutator function. **As a part of your fetch, `console.log` the response body data that you receive.**
...
Finally, zip the `hw3` folder and submit to Gradescope. **You may need to remove the `node_modules` folder before zipping.** Autograding tests should complete within a few minutes. Review your results, and submit as many times as you need up until the assignment deadline. 🥳
